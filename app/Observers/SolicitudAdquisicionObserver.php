...
class SolicitudAdquisicionObserver
{
  ...
  public function created(Solicitud_adquisicion $data)
  {
    ...
    $bitacora->detalle = "Solicitud de adquisicion N° " . $data->codigo_solicitud_a . " registrado";
    $bitacora->save();
  }
  ...
  public function deleting(Solicitud_adquisicion $data)
  {
    ...
    $bitacora->modulo = "Solicitud de adquisicion";
    $bitacora->detalle = "Solicitud de adquisicion N° " . $data->codigo_solicitud_a . " eliminado";
    $bitacora->save();
  }
