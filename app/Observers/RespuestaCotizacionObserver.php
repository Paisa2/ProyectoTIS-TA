...
class RespuestaCotizacionObserver
{
  ...
  public function created(RespuestaCotizacion $data)
  {
    ...
    $bitacora->detalle = "Propuesta de cotizacion de la empresa " . $data->razon_social . " registrado";
    $bitacora->save();
  }
  ...
  public function deleting(RespuestaCotizacion $data)
  {
    ...
    $bitacora->modulo = "Propuesta de cotizacion";
    $bitacora->detalle = "Propuesta de cotizacion de la empresa " . $data->razon_social . " eliminado";
    $bitacora->save();
  }
}