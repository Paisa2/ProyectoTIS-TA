...
class ComparativoCotizacionObserver
{
  ...
  public function created(ComparativoCotizacion $data)
  {
    ...
    $bitacora->detalle_bitacora = "Cuadro comparativo de cotizaciones N° " . Solicitud_cotizacion::where("id", $data->cotizacion_id)->first()->codigo_cotizacion . " registrado";
    $bitacora->save();
  }
  ...
  public function deleting(ComparativoCotizacion $data)
  {
    ...
    $bitacora->modulo = "Cuadro comparativo de cotizaciones";
    $bitacora->detalle_bitacora = "Cuadro comparativo de cotizaciones N° " . Solicitud_cotizacion::where("id", $data->cotizacion_id)->first()->codigo_cotizacion . " eliminado";
    $bitacora->save();
  }
}