...
class SolicitudCotizacionObserver
{
  ...
  public function created(Solicitud_cotizacion $data)
  {
    ...
    $bitacora->detalle_bitacora = "Solicitud de cotizacion N° " . $data->codigo_cotizacion . " registrado";
    $bitacora->save();
  }
  ...
  public function deleting(Solicitud_cotizacion $data)
  {
    ...
    $bitacora->modulo = "Solicitud de cotizacion";
    $bitacora->detalle_bitacora = "Solicitud de cotizacion N° " . $data->codigo_cotizacion . " eliminado";
    $bitacora->save();
  }
}